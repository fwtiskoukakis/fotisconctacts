...
BEGIN
    ...
    -- Photos policies (old schema)
    DROP POLICY IF EXISTS "Users can view photos for visible contracts" ON public.photos;
    DROP POLICY IF EXISTS "Users can insert photos for their contracts" ON public.photos;
    DROP POLICY IF EXISTS "Users can update photos for their contracts" ON public.photos;
    DROP POLICY IF EXISTS "Users can delete photos for their contracts" ON public.photos;
END $$;
...
-- ==============================================
-- CARS TABLE (MISSING - THIS IS THE KEY FIX)
-- ==============================================
...
BEGIN
    ...
    RAISE NOTICE '📊 Tables created/verified: users, cars, contracts, damage_points, contract_photos, notifications';
    RAISE NOTICE '🔒 RLS policies recreated for all tables';
